...
import com.jesushzc.core.domain.run.RunId
...
import com.jesushzc.core.util.Constants
...
class OfflineFirstRunRepository(
    ...
    override suspend fun logout(): EmptyDataResult<DataError.Network> {
        val result = client.get<Unit>(
            route = Constants.ENDPOINT_LOGOUT
        ).asEmptyDataResult()
